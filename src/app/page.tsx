    ...
    <main>
      <section className="mx-auto grid max-w-[1280px] gap-16 px-5 py-[clamp(4.5rem,9vw,8rem)] md:px-8 lg:grid-cols-12 lg:gap-x-8">
        <div className="lg:col-span-8">
          ...
          <p className="mt-8 max-w-[65ch] text-base leading-[1.85] text-on-surface-variant md:mt-10 md:text-[1.0625rem]">
        ...
        <aside className="lg:col-start-10 lg:col-span-3 lg:pt-7">
          <div className="flex flex-col items-center text-center">
            <div className="profile-float h-24 w-24 shrink-0 overflow-hidden rounded-full border border-outline-variant bg-surface-container-lowest lg:h-28 lg:w-28">
              <Image
          ...
          <dl className="mt-8 border-t border-outline-variant lg:mt-10">
            {skillGroups.map((group) => (
              <div key={group.label} className="border-b border-outline-variant py-4">
      ...
      <section
        id="articles"
        className="mx-auto max-w-[1280px] scroll-mt-24 px-5 pb-[clamp(4.5rem,9vw,8rem)] md:px-8"
      >
