  ...
  return (
    <html lang="ja">
      <body>
        ...
        `}</Script>
        <div className="flex h-20 items-center justify-normal bg-blue-800 p-5">
          <a
            className="cursor-pointer text-2xl font-semibold hover:opacity-50 md:text-3xl"
            href="/"
          >
            {BLOG_NAME}
          </a>
          ...
          <a href="https://twitter.com/ymnk_8752">
            <svg
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a href="https://www.wantedly.com/id/junichi_yamanaka">
            <svg
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a href="https://note.com/panda_p" className="ml-3 text-gray-600 hover:opacity-50">
            note
          </a>
          <a href="https://sizu.me/junichi_y">
